...
/// 26
const double d_margin3025 = 26; // 3.25 * 8
/// 28
const double d_margin305 = 28; // 3.5 * 8
/// 32
const double d_margin4 = 32; // 4 * 8
/// 36
const double d_margin405 = 36; // 4.5 * 8
/// 38
const double d_margin4075 = 38; // 4.75 * 8
/// 40
const double d_margin5 = 40; // 5 * 8
/// 48
const double d_margin6 = 48; // 6 * 8
/// 50
const double d_margin6025 = 50; // 6.25 * 8
/// 56
const double d_margin7 = 56; // 7 * 8
/// 60
const double d_margin705 = 60; // 7.5 * 8
/// 62
const double d_margin7075 = 62; // 7.75 * 8
/// 64
...
/// 104
const double d_margin13 = 104; // 13 * 8
/// 90
const double d_margin11025 = 90; // 11.25 * 8
/// 116
const double d_margin1405 = 116; // 14.5 * 8
/// 118
const double d_margin14075 = 118; // 14.75 * 8
/// 160
const double d_margin20 = 160; // 20 * 8
/// 240
const double d_margin30 = 240; // 30 * 8
/// 298
const double d_margin37025 = 298; // 37.25 * 8
...
const double d_borderRadius = 8;

/// 6
///
/// Radius used for most of the rounded-bordered components like dialog, snack bar, etc.
const double d_borderRadiusM = 6;

/// 3
///
/// Radius half of [d_borderRadiusM]
